  ...
  return (
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={[styles.dot, { top: 140, right: 60 }]} />
        <View style={[styles.dot, { bottom: 120, right: 40 }]} />
        <View style={[styles.dotSmall, { top: 200, left: 80 }]} />
        <View style={[styles.dotSmall, { bottom: 200, left: 50 }]} />
